...
const description = "Optimize your portfolio with the power of our Artificial Intelligence. Unique insights to make smart and data-driven investment decisions.";
const image = process.env.NEXT_PUBLIC_CDN_URL + "/images/share/logoDanelfin.png";

         ...
         {isCompare ? <>
          <p className='title'>{t('comparePage.bestStocks.title')}</p>
              <p className='description'>
                ...
                <span className="description-percentage">{t('comparePage.bestStocks.usdescriptionPercentage')}</span>
          ...
          <div className="home-tables-title">
              <h2>{t(`home.stockTables.${topStocksActive ? "topStocks" : "etfs"}.title`)}</h2>
              <p>{t(`home.stockTables.${topStocksActive ? "topStocks" : "etfs"}.description`)}</p>
          </div>
